...
// =========================
// ASK THE PHILOSOPHER PAGE
// =========================

const philosopherButtons = document.querySelectorAll(".philosopher-button");
const philosopherQuestion = document.getElementById("philosopherQuestion");
const philosopherAnswer = document.getElementById("philosopherAnswer");
const philosopherAnswerTitle = document.getElementById("philosopherAnswerTitle");
const philosopherAnswerText = document.getElementById("philosopherAnswerText");

if (philosopherButtons.length > 0) {
  philosopherButtons.forEach((button) => {
    button.addEventListener("click", async () => {

      const question = philosopherQuestion.value.trim();
      ...
      philosopherAnswerTitle.textContent = philosopher;
      philosopherAnswerText.textContent = "Thinking...";
